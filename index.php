...
<p>
In this way the worm can be induced to paralyze, lay eggs, back up, speed up or sense touch in different areas of its body. The Samuel Lab is using this tool to study different neurocircuits in the worm. Videos of the CoLBeRT system are <a href="videos.php">available here</a>. All of the associated software and souce code for the CoLBeRT system is free to download. For more information see the original article in <i>Nature Methods</i> <a href="media/leifer_et_al_2011.pdf">[ PDF ]</a>.
