<?php
	$title="Optogenetic tool for neuroscience";
	include("header.inc");
?>
<!------- END OF TOP MATTER -->
...
<p>CoLBeRT is a new technique for neuroscience developed by the <a href="http://worms.physics.harvard.edu"/>Samuel Lab</a> at Harvard University's <a href="http://cbs.fas.harvard.edu/">Center For Brain Science</a> that allows researchers to commandeer the nervous system of a moving animal without wires or electrodes. The system has been used thus far on the microscopic nematode <em>C. elegans</em>. See the recent articles about the CoLBeRT system in <a href="http://www.sciencenews.org/view/generic/id/68860/description/Making_a_worm_do_more_than_squirm#video" target="_blank"><i>Science News</i></a> and <a href="http://www.scientificamerican.com/article.cfm?id=single-worm-neurons" target="_blank"><i>Scientific American</i></a>.</p>
...
<p>
In this way the worm can be induced to paralyze, lay eggs, back up, speed up or sense touch in different areas of its body. The Samuel Lab is using this tool to study different neurocircuits in the worm. Videos of the CoLBeRT system are <a href="videos.php">avaialable here</a>. All of the associated software and souce code for the CoLBeRT system is free to download. For more information see the original article in <i>Nature Methods</i> <a href="media/leifer_et_al_2011.pdf">[ PDF ]</a>.
...
<a href="http://www.flickr.com/photos/mikebrowne/4365625233/lightbox/"><img class="right" alt="Stephen Colbert" src="images/colbert_mikeBrowne_small.jpg" ></a>
The CoLBeRT project is dedicated to its namesake, <a href="http://colbertnation.com">Stephen Colbert</a>, who manipulates the neurocircuits of millions of Americans daily using only the light from their monitors. Photo (cc) <a href="http://www.flickr.com/photos/mikebrowne/">MikeBrowne</a>.
</div>
<div class="box">
...
Blue light causes the worm to experience the sensation of touch, and so it recoils. <a href="vidoes.php">More videos</a>.
